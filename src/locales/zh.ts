...
export const zh: Translations = {
  ...
  hero: {
    ...
    description: '致力于人工智能相关研究，深耕 LLM 预训练与后训练、Agent 架构设计，以及生物信息学与深度学习的交叉应用。依托扎实的理论数学功底，我坚信严格的数学推演与计算科学的结合将不断拓宽智能系统的边界。对我而言，探索人工智能不仅是一项深爱的科研事业，更是不断追求真理、用理性与技术解码复杂世界的终身使命。',
    btnPrimary: '探索我的研究',
  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        date: "企业项目",
        description: "为企业开发自动化的文献排版与格式化处理智能体，大幅提升工作流效率。",
      ...
      },
      {
        ...
        company: "科研项目",
        date: "进行中",
        description: "独立设计并从零预训练一套新架构，专门用于将 PDF 文档转化为 LaTeX 格式，致力于高保真提取科学公式和排版结构。",
        tags: ["视觉模型", "从头预训练", "LaTeX", "文档 AI"],
        subItem: {
          title: "后训练算法改进",
          company: "科研项目",
          date: "进行中",
          description: "研究小模型在数学推理方面的受限问题，探索后训练对齐技术与强化学习方法来提升小模型的推理能力。",
          tags: ["大语言模型", "后训练", "数学推理"]
        }
      }
    ],
